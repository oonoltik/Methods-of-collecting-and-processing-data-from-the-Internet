...
class InstagramSpider(scrapy.Spider):
    ...
    parse_users = ['ai_machine_learning','ai_machine_learning_iot', 'big_data_freedom']    #Пользователи, у которого собираем посты. Можно указать список
    ...
    # num_for_first = 50             # определяем кол-во данных на страницах edges
